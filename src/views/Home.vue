...
<!-- Statement -->
      <section class="spotlight style1 orient-right onscroll-image-fade-in onscroll-content-fade-in">
        <div class="content">
          <h3>"The same boiling water that softens the potato hardens the egg. It's about what you're made of, not the circumstances."</h3>
          <i style="color:red;">- Mel Robbins</i>
        </div>
        <div class="image">
...
<!-- BlockHound -->
      <section class="banner style1 halfscreen onscroll-image-fade-in onscroll-content-fade-in orient-left">
        <div class="content">
          ...
          <br>
          <a href="https://acnikzad.herokuapp.com/blockhound" class="button">Learn More</a>
...
<!-- Corsega -->
      <section class="banner style1 onscroll-content-fade-down orient-right">
        <div class="content">
          ...
          <a href="https://acnikzad.herokuapp.com/corsega" class="button">Learn More</a>
        </div>
        <div class="image">
