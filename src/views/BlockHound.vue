  ...
  <div class="Corsega">
    ...
    <section class="banner style1 halfscreen onload-content-fade-down onscroll-image-fade-in orient-right">
      <div class="content">
        <h2>BlockHound</h2>
        <hr>
        <h4>For my final project of my coding bootcamp using a culmination of my acquired skill sets, APIs, and GoogleMaps, I created BlockHound. I used Ruby on Rails for the backend, a mixture of HTML, CSS, and Javascript in the Vue.js framework for the front end. I purchased a GPS device from Logistimatics, a North Carolina based company that specializes in tracking devices. By subscribing to their API key, I was able to integrate data obtained from the GPS device I fixed to my dogs collar.</h4>
        <div class="dev-icons">
          <center>
            ...
            <i id="prog-icon" class="devicon-javascript-plain"></i>
            <i id="prog-icon" class="devicon-bootstrap-plain"></i>
          </center>
        </div>
        <br>
        <br>
